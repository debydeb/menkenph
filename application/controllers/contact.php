...
class Contact extends CI_Controller {
	...
	public function Index() {
		...
		$this->form_validation->set_rules('name','Name', 'required|alpha|xxs_clean|min_length[4]|max_length[8]');
		$this->form_validation->set_rules('lstname','Last Name', 'required|alpha|xxs_clean|min_length[4]|max_length[8]');
		$this->form_validation->set_rules('phone','Telefono', 'required|xxs_clean|numeric|integer');
		$this->form_validation->set_rules('email','E-mail', 'required|xxs_clean|valid_email');
		$this->form_validation->set_rules('msj','Mensaje', 'required|xxs_clean|min_length[10]');
