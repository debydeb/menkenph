	<div class="container" id="home">
		...
		<div id="content">
			<div class="content-grid-inves-garan">
			<img src="<?php echo base_url(); ?>img/investigacion.jpg" class="inves-garan"/>
				<h1>Investigaci&oacute;n y Desarrollo</h1>
			...
			<img src="<?php echo base_url(); ?>img/calidad.jpg" class="calidad"/>
				<h1>Calidad</h1>
				<p>Nuestro sistema de calidad continua 
				asegura que usted est&aacute; recibiendo el material 
				en perfectas condiciones de uso.</p>
			</div>
			<div class="content-grid-inves-garan">
			<img src="<?php echo base_url(); ?>img/garantia.jpg" class="inves-garan"/>
				<h1>Garant&iacute;a FICO &#38; Br&uuml;cke</h1>
